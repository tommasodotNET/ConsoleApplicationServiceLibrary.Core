using ConsoleApplicationServiceLibrary.Attributes;
...
namespace ConsoleApplicationServiceLibrary.Extensions
{
   public static class ServiceCollectionExtensions
   {
      ...
      public static IServiceCollection AddDbContextWithReflection(this IServiceCollection services, IConfigurationRoot configuration)
      {
      ...
      private static IServiceCollection AddDbCustom<T>(IServiceCollection services, IConfigurationRoot configuration, string connectionString)
          where T : DbContext
      {
